...
func hasUndesiredUserAgentE9(remoteAddress string, agent string, blacklistedAgents, whitelistedAgents []string) bool {
...
func handleHelloE9(wsc AbstractSocketClient, icmd interface{}) error {
	...
	if hasUndesiredUserAgentE9(wsc.RemoteAddr(), Agent, wsc.GetAgentBlacklist(), wsc.GetAgentWhitelist()) {
